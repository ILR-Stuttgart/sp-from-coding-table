...
mt$is.learner.ip <- ifelse(mt$cumFreq.rank <= ntrim.inclass & mt$cumFreq > 0, TRUE, FALSE) # inexperienced, panchronic
mt$is.learner.is <- ifelse(mt$cumFreq.window.rank <= ntrim.inclass & mt$cumFreq.window > 0, TRUE, FALSE) # inexperienced, time-limited
#########################################################
